...
- [**PayloadsAllTheThings**](https://github.com/swisskyrepo/PayloadsAllTheThings): Página muy recomendable sobre las distintas técnicas en el lanzamiento de diferentes tipos de *shells*, explorar otros metodos y aplicar opciones avanzadas.
